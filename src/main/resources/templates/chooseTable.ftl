...
<@common.page>
    ...
    <div class="container" style="padding-top: 5vh;">
        <div class="card-deck mb-3 text-center">
            ...
            <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                    <p style="margin-top: 5vh">Информация о линиях заказов</p>
                    <form action="/warehouseOrderLines">
                        <button type="button" class="btn btn-lg btn-block btn-outline-primary" style="margin-top: 5vh">
                            Просмотреть
                        </button>
                    </form>
                </div>
    ...
    <div class="container" style="padding-top: 3vh;">
        <div class="card-deck mb-3 text-center">
            <div class="card mb-4 box-shadow">
                <div class="card-header">
                    <h4 class="my-0 font-weight-normal">Наличие</h4>
                </div>
                <div class="card-body">
                    <p style="margin-top: 5vh">Информация о количестве продукции и материалов</p>
                    <form action="/users">
                        <button class="btn btn-lg btn-block btn-outline-primary" style="margin-top: 5vh">Просмотреть
                        </button>
                    </form>
            ...
            <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                    <p style="margin-top: 5vh">Информация о продукции и материалах></p>
                    <form action="/invent">
                        <button type="button" class="btn btn-lg btn-block btn-outline-primary" style="margin-top: 5vh">
                            Просмотреть
                        </button>
            ...
            <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                    <p style="margin-top: 5vh">Информация о комплектациях продукции</p>
